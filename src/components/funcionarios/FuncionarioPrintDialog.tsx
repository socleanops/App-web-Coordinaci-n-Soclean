        ...
        employees.forEach(emp => {
            ...
            tableHtml += `
              <tr>
                ...
                ${selectedColumns.fecha_ingreso ? `<td>${emp.fecha_ingreso && !isNaN(new Date(emp.fecha_ingreso).getTime()) ? dateFormatter.format(new Date(emp.fecha_ingreso)) : (emp.fecha_ingreso ? 'Fecha Inválida' : '')}</td>` : ''}
