...
interface Props {
    ...
    clienteToEdit?: Record<string, unknown> | null; // usually Cliente type
}
...
export function ClienteFormDialog({ open, onOpenChange, clienteToEdit }: Props) {
    ...
    const form = useForm<ClienteFormData>({
        resolver: zodResolver(clienteSchema) as unknown as Record<string, unknown>,
        defaultValues: {
            razon_social: '',
            nombre_fantasia: '',
            rut: '',
    ...
    useEffect(() => {
        if (clienteToEdit) {
            form.reset({
                ...
                estado: clienteToEdit.estado as unknown as Record<string, unknown> || 'activo',
            });
        } else {
            form.reset({
                razon_social: '',
