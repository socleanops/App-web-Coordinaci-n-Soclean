...
<<<<<<< HEAD
            return await funcionarioService.getFuncionarios();
=======
...
>>>>>>> origin/dev
    ...
    const getDepartamentos = useQuery({
        ...
        queryFn: async () => {
<<<<<<< HEAD
            return await funcionarioService.getDepartamentos();
=======
...
>>>>>>> origin/dev
    ...
    const createDepartamento = useMutation({
        mutationFn: async (nombre: string) => {
            return await funcionarioService.createDepartamento(nombre);
        },
        onSuccess: () => {
...
<<<<<<< HEAD
                try {
                    const result = await funcionarioService.createFuncionario(formData, updateStep);
                    toast.success('5/5 Operación exitosa!', { id: tid });
                    return result;
                } catch (error: any) {
                    toast.error(error.message || 'Error desconocido durante la creación', { id: tid });
                    throw error;
                }
=======
...
>>>>>>> origin/dev
    ...
    const updateFuncionario = useMutation({
        mutationFn: async ({ id, data }: { id: string; data: Partial<FuncionarioFormData> }) => {
            return await funcionarioService.updateFuncionario(id, data);
        },
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['funcionarios'] });
        },
    ...
    const resetPassword = useMutation({
        mutationFn: async ({ profileId, newPassword }: { profileId: string; newPassword: string }) => {
            return await funcionarioService.resetPassword(profileId, newPassword);
        }
    });
