            ...
            <Dialog open={resetDialogOpen} onOpenChange={setResetDialogOpen}>
                <DialogContent className="sm:max-w-md">
                    ...
                    <div className="bg-amber-50 dark:bg-amber-900/20 text-amber-800 dark:text-amber-400 p-4 border border-amber-200 dark:border-amber-800 rounded-md text-sm mt-2 mb-4">
                        Esto invalidará su sesión actual y generará una nueva contraseña segura temporal. Podrás indicarle manualmente cuál es su nueva clave para que vuelva a entrar de inmediato.
                    </div>
